...
public class Statement_multi extends Statement_list {

    private Statement_list statement_list;
    private Statement statement;

    public Statement_multi (Statement_list statement_list, Statement statement) {
