...
public class More_factor_multi extends More_factor_list {

    private More_factor_list more_factor_list;
    private More_factor_part more_factor_part;

    public More_factor_multi (More_factor_list more_factor_list, More_factor_part more_factor_part) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("More_factor_multi(\n");
