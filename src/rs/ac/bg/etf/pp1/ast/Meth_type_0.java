...
public class Meth_type_0 extends Method_type_decl {
    ...
    public Meth_type_0 (Method_type_name method_type_name, Method_parameters method_parameters, Var_declaration_list var_declaration_list, Statement_list statement_list) {
