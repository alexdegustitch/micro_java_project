...
public class Meth_void_6 extends Method_void_decl {

    private Method_void_name method_void_name;
    private Statement_list statement_list;

    public Meth_void_6 (Method_void_name method_void_name, Statement_list statement_list) {
