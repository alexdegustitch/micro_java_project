...
public class Meth_void_4 extends Method_void_decl {
    ...
    public Meth_void_4 (Method_void_name method_void_name, Var_declaration_list var_declaration_list, Statement_list statement_list) {
