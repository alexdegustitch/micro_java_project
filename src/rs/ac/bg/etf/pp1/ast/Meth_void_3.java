...
public class Meth_void_3 extends Method_void_decl {

    private Method_void_name method_void_name;
    private Method_parameters method_parameters;

    public Meth_void_3 (Method_void_name method_void_name, Method_parameters method_parameters) {
