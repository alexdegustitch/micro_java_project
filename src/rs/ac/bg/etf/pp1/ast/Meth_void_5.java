...
public class Meth_void_5 extends Method_void_decl {

    private Method_void_name method_void_name;
    private Var_declaration_list var_declaration_list;

    public Meth_void_5 (Method_void_name method_void_name, Var_declaration_list var_declaration_list) {
